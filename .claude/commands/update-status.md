...
| 文件 | 完整度贡献 |
|------|----------|
| `frontend/src/views/QueryView.vue` | 主页面 |
| `frontend/src/stores/queryStore.ts` | 状态管理 |
| `frontend/src/api/query.ts` | API 封装 |
